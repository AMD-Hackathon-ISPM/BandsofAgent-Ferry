...
function RosterRow({
  ...
  return (
    <button
      ...
      className={cn(
        "flex w-full items-center gap-2.5 px-2.5 py-2 text-left outline-none transition-colors",
...
export function AgentRoster({
  ...
  return (
    <section className={cn("flex flex-col", className)} aria-label="Agent roster">
      <div className="flex items-center justify-between border-b border-border px-3 py-2.5">
        <h2 className="text-xs font-semibold tracking-wide">The band</h2>
